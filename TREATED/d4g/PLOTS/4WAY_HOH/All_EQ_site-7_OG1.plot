...
set title "THR 6, OG1 (Initial Equilbrated)"
set term post enh color 16
set output "All_EQ_site-7_OG1.ps"
plot "All_EQ_site-7_OG1_binned.dat" using 1:2:5 with image
set term png crop
set output "All_EQ_site-7_OG1.png"
plot "All_EQ_site-7_OG1_binned.dat" using 1:2:5 with image
