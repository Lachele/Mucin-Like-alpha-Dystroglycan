...
set title "H...O...H Fraction Details for Glycosidic Oxygen" 
...
set output "H-O-H_fractions_glycosidic_detail.ps"
plot '../../SPREADSHEETS/glycosidic_O_details.dat' using 3:xtic(2) ti 'Hb and Hg', '' u 4 ti 'Hb Only', '' u 5 ti 'Hg Only', '' u 6 ti 'Neither'

set term png crop fontscale 0.9
set output "H-O-H_fractions_glycosidic_detail.png"
plot '../../SPREADSHEETS/glycosidic_O_details.dat' using 3:xtic(2) ti 'Hb and Hg','' u 4 ti  'Hb Only',  '' u 5 ti 'Hg Only', '' u 6 ti 'Neither'
