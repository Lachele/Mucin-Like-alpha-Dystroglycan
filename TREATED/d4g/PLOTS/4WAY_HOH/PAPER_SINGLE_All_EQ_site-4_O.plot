...
set title "THR 3, Backbone O"
set term post enh color 16
set output "PAPER_SINGLE_All_EQ_site-4_O.ps"
plot "All_EQ_site-4_O_binned.dat" using 1:2:5 with image
set term png crop
set output "PAPER_SINGLE_All_EQ_site-4_O.png"
plot "All_EQ_site-4_O_binned.dat" using 1:2:5 with image
